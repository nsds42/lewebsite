	...
	<div class="container">
		<div class="eight columns" data-appear-top-offset="-100" data-animated="fadeInLeft">
			<h2><i class="icon-briefcase"></i> <?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: %s', 'liwa' ), get_the_date() );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', 'liwa' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'liwa' ) ) );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', 'liwa' ), get_the_date( _x( 'Y', 'yearly archives date format', 'liwa' ) ) );
